...
func gamble(gamba util.Gamba) (int64, int64) {
	pressA, pressB := int64(0), int64(0)

	x1 := int64(gamba.ButtonA.X)
	y1 := int64(gamba.ButtonA.Y)

	x2 := int64(gamba.ButtonB.X)
	y2 := int64(gamba.ButtonB.Y)

	x := int64(gamba.Prize.X)
	y := int64(gamba.Prize.Y)
